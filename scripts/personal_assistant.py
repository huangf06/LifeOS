...
class PersonalAssistant:
    ...
    def parse_user_input(self, user_input):
        ...
        task_indicators = [
            ...
            "收拾", "打扫", "洗", "晾",
            # 开始/创建类
            "开始", "启动", "搭建", "建立", "创建", "制作", "设计", "开发",
            "构建", "规划", "计划", "构思", "实施", "执行", "落实",
            # 观看/娱乐类
            "看", "看完", "观看", "追", "追剧", "刷", "听", "玩", "打",
            # 练习/运动类
            "练", "练习", "操练", "演练", "跑", "游", "健身", "锻炼",
            # 社交/参与类
            "参加", "出席", "加入", "见", "拜访", "面试",
            # 完成类
            "做完", "写完", "读完", "弄", "搞", "办"
    ...
    def _extract_project(self, text):
        ...
        project_keywords = {
            "fitness": ["健身", "运动", "锻炼", "跑步", "力量", "瑜伽", "游泳", "训练",
                       "workout", "movement", "flow", "拉伸", "体能", "有氧", "无氧"],
            "career": ["面试", "简历", "求职", "招聘", "投递", "笔试", "作品集",
                      "job", "职位", "工作", "offer", "HR", "猎头", "内推", "系统搭建"],
            "english": ["英语", "学习", "口语", "听力", "阅读", "写作", "单词", "语法",
                       "English", "英文", "雅思", "托福", "GRE"],
            "errands": ["买", "购", "取", "送", "快递", "医院", "体检", "缴费", "预约",
                       "收拾", "整理", "打扫", "洗", "晾", "修理", "换", "办理"]
        }
